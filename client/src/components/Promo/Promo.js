        ...
        <div className="promo__inner">
          <div className="promo__data">
            ...
            <p className="promo__text">
              Вітаємо у ресторані Mediterra Delights, де ви зможете найкращі
              страви від наших кухарів. Наше меню насичене вишуканими стравами,
              які сповнені свіжості, аромату та витонченості.
            </p>
